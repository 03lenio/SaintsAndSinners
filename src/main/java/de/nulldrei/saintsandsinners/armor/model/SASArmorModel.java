...
public class SASArmorModel <T extends LivingEntity> extends HumanoidModel<T> implements IClientItemExtensions {
    ...
    public SASArmorModel(ModelPart root, ArmorItem.Type slot) {
        super(root);
        this.slot = slot;
        this.root = root;
