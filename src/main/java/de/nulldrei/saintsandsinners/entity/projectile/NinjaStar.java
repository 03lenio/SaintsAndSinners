...
public class NinjaStar extends ThrowableItemProjectile {
    ...
    public NinjaStar(Level p_37399_, LivingEntity p_37400_) {
        super(SASEntities.NINJA_STAR.get(), p_37400_, p_37399_);
    }

    public NinjaStar(Level p_37394_, double p_37395_, double p_37396_, double p_37397_) {
        super(SASEntities.NINJA_STAR.get(), p_37395_, p_37396_, p_37397_, p_37394_);
    }

    protected Item getDefaultItem() {
        return SASItems.NINJA_STAR.get();
    }
    ...
    protected void onHitEntity(EntityHitResult p_37259_) {
      if(!level().isClientSide()) {
            ...
            if(getOwner() instanceof Player) {
                source = SASDamageTypes.Sources.projectile(level().registryAccess(), this, (Player)getOwner());
            } else {
