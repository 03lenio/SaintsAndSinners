...
public class ReclaimedFactionSurvivor extends AbstractFactionSurvivor implements VariantHolder<ReclaimedVariant>, CrossbowAttackMob {
    ...
    public static final EntityDataAccessor<Integer> DATA_ID_TYPE_VARIANT = SynchedEntityData.defineId(ReclaimedFactionSurvivor.class, EntityDataSerializers.INT);

    public ReclaimedFactionSurvivor(EntityType<? extends AbstractFactionSurvivor> p_35048_, Level p_35049_) {
    ...
    @Override
    public void setVariant(ReclaimedVariant p_262689_) {
        this.setTypeVariant(p_262689_.getId() & 255 | this.getTypeVariant() & -256);
    }

    @Override
    public ReclaimedVariant getVariant() {
        return ReclaimedVariant.byId(this.getTypeVariant() & 255);
    }
