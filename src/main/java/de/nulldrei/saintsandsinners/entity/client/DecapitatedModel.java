...
public class DecapitatedModel<T extends Mob> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(SaintsAndSinners.MODID, "decapitated_layer"), "main");
	...
	public DecapitatedModel(ModelPart root) {
