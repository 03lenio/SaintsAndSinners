...
public class StartBegging {
        ...
        return BehaviorBuilder.create((p_259197_) -> {
            return p_259197_.group(p_259197_.present(MemoryModuleType.NEAREST_VISIBLE_PLAYER)).apply(p_259197_, (p_259512_) -> {
                return (p_289481_, p_289482_, p_289483_) -> {
                    if (p_289482_.getOffhandItem().isEmpty()) {
                        if(p_289482_ instanceof  BeggarSurvivor) {
                            ...
                            beggarSurvivor.getEntityData().set(BeggarSurvivor.DATA_ACTIVELY_BEGGING, true);
                        }
                        return true;
                    } else {
                        return false;
